...
#include <stdio.h>
#include <string>
#define HIMAWARI_TEST_DATA_DIR_PATH "E://02-QtProject//HSD2TMS//data//HS_H08_20150125_0230_JP02//"
...
TEST_GROUP(HimawariStandardDataTest) {
    ...
    TEST_SETUP() {
        ...
        for (int i = 5; i <= 16; i++) {
//            qDebug() << QString(QLatin1String(leaf)) << sizeof(leaf) << "HS_H08_20150125_0230_B%02d_JP02_R20_S0101.DAT" << 1;
//            snprintf(leaf, sizeof(leaf),
//                     "HS_H08_20150125_0230_B%02d_JP02_R20_S0101.DAT", i);
//            std::cout << leaf << std::endl;
//            std::cout << sizeof(leaf) << std::endl;
//            std::cout << "HS_H08_20150125_0230_B%02d_JP02_R20_S0101.DAT" << std::endl;
//            std::cout << i << std::endl;
            path.assign(HIMAWARI_TEST_DATA_DIR_PATH);
            path.append(leaf);
//            himawariData.append(path.c_str());
...
TEST(HimawariStandardDataTest, FileHeaderCheck) {
    for (const hsd2tms::HimawariStandardDataSegment& segment:
        ...
        DOUBLES_EQUAL(140.7,        pi.body.mSubLon,         FLT_EPSILON);
    }
}
